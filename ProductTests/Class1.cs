...
namespace ProductTests
{
    public class Class1
    {
        ...
        public class ProductTest1
        {
            ...
            [Test]
            public void ValidProductName_Input6andIphoneand650and7_OutputProductID()
            {
                //Arrange
                int productID = 6;
                string productName = "Iphone";
                ...
                //Act
                Product product = new Product(productID, productName, price, stock);
                int actual = product.ProductName;
            ...
            [Test]
            public void ValidProductName_Input6andAsusand650and7_OutputProductID()
            {
                //Arrange
                int productID = 6;
            ...
            public void ValidIncreaseStock_Input750anDelland2700and100and6_OutputIncreasedstock()
            {
                ...
                int actual = product.ProductStock;
